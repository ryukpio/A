...
bot = telebot.TeleBot('7283418311:AAHGXmJRi6tKbDHH9cTx7E7auFTdxgfhcqw')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:- @sivsiv11."
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝙏𝙝𝙞𝙨 𝘽𝙤𝙩 𝙞𝙨 𝙤𝙣𝙡𝙮 𝙛𝙤𝙧 𝙥𝙖𝙞𝙙 𝙪𝙨𝙚𝙧𝙨 𝙗𝙪𝙮 𝙣𝙤𝙬 𝙛𝙧𝙤𝙢 - @sivsiv11 \n https://t.me/V3NOM_CHEAT/13 "
        bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @sivsiv11 - https://t.me/V3NOM_CHEAT/13")
...
Buy From :- @sivsiv11
Official Channel :- https://t.me/cheap_ddos
'''
...
3. MAKE SURE YOU JOINED https://t.me/cheap_ddos OTHERWISE NOT WORK
